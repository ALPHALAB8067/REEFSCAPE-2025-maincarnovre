...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  public double XPose(double X)
   {
    PIDController TranslationPIDX = new PIDController(1,0.0001,0);
  ...
  public double YPose(double Y)
   {
  PIDController TranslationPIDY = new PIDController(1.5,0.0001,0) ;
  ...
  public Double RotPose(double Rot)
   {
  PIDController TurnPID = new PIDController(1,0.0001,0) ;
